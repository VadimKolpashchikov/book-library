...
var Main = /*#__PURE__*/function (_AbstractView) {
  function Main(appState) {
    ...
    _this.appState = onChange(appState, _this.appStateHook.bind(_this));
  ...
  return _createClass(Main, [{
    key: "appStateHook",
    value: function appStateHook(path) {
      if (path === 'favorites') {
        this.render();
      }
    }
    ...
    value: function render() {
      ...
      main.innerText = "\u0427\u0438\u0441\u043B\u043E \u043A\u043D\u0438\u0433 ".concat(this.appState.favorites.length);
      this.$app.innerHTML = '';
